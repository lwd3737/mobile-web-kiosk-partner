    ...
    <S.GlobalLayout>
      {isLogin && (
        <header className="global-header">
          ...
          <NavLink className="nav-item" to={basePath} activeStyle={activeStyle}>
            홈
          </NavLink>
          <NavLink
            className="nav-item"
      ...
      <Switch>
        <main className="contents">
          ...
          <Route path={`${basePath}/users`}>users management</Route>
          <Route path={`${basePath}/rooms`}>
            <RoomAndSeatManagement basePath={`${basePath}/rooms`} />
          </Route>
          <Route path={`${basePath}/usetickets`}>
            <UseTicketManagement />
          </Route>
        </main>
      </Switch>
