  ...
  return (
    <S.SeatsDetail>
      <div className="contents">
        ...
        />
        <SeatsInfo roomName={roomName} seatsInfo={seatsInfo} />
      </div>

      <div className="btn-wrapper">
        <SimpleButton backgroundColor="gray1" onClick={handleMoveRoomListClick}>
          공간 목록
        </SimpleButton>
        <SimpleButton
        ...
        <SimpleButton onClick={handleNextClick}>{nextBtnText}</SimpleButton>
      </div>
    </S.SeatsDetail>
  );
}
